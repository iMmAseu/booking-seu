...
import { UserOrderlistData } from '../../Utils/UserorderlistData';
const Orderlist = () => {
    const orders = UserOrderlistData;
    return (
        <div className={styles.Orderlist}>
            <div class="top-bar">
                <svg viewBox="0 0 256 48" xmlns="http://www.w3.org/2000/svg" class="icon-logo" width="110" height="24">
                ...
                <img class="bui-avatar-image" src="https://t-cf.bstatic.com/design-assets/assets/v3.68.0/images-flags/Cn@3x.png" alt="China's-flag"></img>
            </div>
