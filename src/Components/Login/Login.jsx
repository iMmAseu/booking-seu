...
const Login = () => {
  ...
  const handleSubmit = (e) => {
    ...
    // 检查邮箱地址和密码是否正确
    if (email === '2720415363@qq.com' && password === '543680bwz') {
  ...
  {/*const responseGoogle = (res) => {
    ...
    setTimeout(() => {
      ...
      if (data) {
        document.location.href = "http://10.203.237.141:3000";
...
export const Logout = () => {
  ...
  return <div className={styles.signButton}>
    ...
    >
      <p style={{ marginBottom: "8px", marginRight: "10px" }} className={styles.logoutText}>登出</p>
    </GoogleLogout>*/}
    <button>登出</button>
