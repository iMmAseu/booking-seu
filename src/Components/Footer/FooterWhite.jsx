...
const FooterWhite = () => {
    return (
        <>
            ...
            <h6 style={{ color: "#0071C2", fontSize: "16px", fontWeight: "700", cursor: "pointer", textAlign: "center" }}>登录后台</h6>
            <div style={{ width: "73%", margin: "auto", textAlign: "center", fontSize: "12px" }}>Copyright © 1996–2023 Booking.com™. All rights reserved.</div>
            <div style={{ fontSize: "13px", padding: "15px", color: "#6B6B6B", textAlign: "center" }}>Booking.com隶属于Booking Holdings Inc.，该集团是深受全球用户好评的在线旅行及周边服务供应商。</div>
